ActiveAdmin.register Analyzable::Employee, as: 'Employee' do
  ...
  index title: 'Employees' do 
    ...
    column 'Employee' do |employee|
      link_to employee.avatar_name, admin_employee_path(employee)
    end
    column 'Employer' do |employee|
      link_to employee.user.avatar_name, admin_user_path(employee.user)
    end
    column :hourly_pay
    column :max_hours
  ...
  filter :user_avatar_name, as: :string, label: 'Employer'
  filter :hourly_pay
  filter :max_hours
