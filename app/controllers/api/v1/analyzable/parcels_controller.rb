    ...
    module Analyzable
      ...
      class ParcelsController < Api::V1::AnalyzableController
        def create
          ...
          @requesting_object.user.parcels << ::Analyzable::Parcel.new(atts.merge('parcel_box_id' => @requesting_object.id))
        ...
        def index
          ...
          page = @requesting_object.user.parcels.where(region: @requesting_object.region).page(params['parcel_page']).per(9)
